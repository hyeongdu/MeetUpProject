...
<div class="row">
	<div style="margin:0 auto; width:1000px;">
          <div style="margin-bottom:20px;"><span style="font-size: 2.0em;"> 신청한 클래스 </span></div>
				  ...
				  <div class="container-fluid">
				    ...
				    <div class="collapse navbar-collapse" id="bs-example-navbar-collapse-1">
				      ...
				      <li><a href="/mypage/mp">마이페이지홈</a></li>
				        ...
				        <li class="active"><a href="viewapplyclass" >신청한 클래스 조회</a></li>
		...
		<div class="row placeholders" id="classmodule">  
	       ...
	       <div class="row placeholders">            
	         <div id="classimage">
	           <img src="/classimages/${aci.tfile }" class="img-responsive" alt="Generic placeholder thumbnail">
	         </div>
	         <div id="classinfo">
	         	<div>
	         		<h3><a href="/view/classview?tid=${aci.tid }">${aci.title }</a></h3>
	         		${aci.tintro }
	         	</div>		         	
	         	<div>	         	
	         				...
	         				<c:forEach var="cmi" items="${classmanagerinfo }">
			         			<c:if test="${cmi.classid eq aci.tid }">
					         		...
					         		<c:when test="${cmi.paycheck eq 'y' }">
						         		<button class="btn btn-default btn-sm " role="button">결제완료</button>
					         		</c:when>
					         		<c:otherwise>
						         		<a class="btn btn-default btn-sm" href="/view/paymentpage?tid=${aci.tid }">결제하기</a>
					         		</c:otherwise>
					         		</c:choose>
				         		</c:if>
			         		</c:forEach>
			         		<button class="btn btn-default btn-sm" onClick="quitcheck()">신청취소</button>
	         			</form>
	         		</div>
	         	</div>	
	         </div>          

...
(시행일) 본 약관은 2019년 11월 07일부터 시행합니다.
	...
	<table class="table" style="align:center">
		<tr>
		<th scope="row">아이디</th>
		<td style="display:none;"><input type="text" id="userID" name="userID" size="20" value="${userid }"></td>
		<td> ${userid }</td>
		<div class="text_wrapper" style="display:none;"><input type="text" id="idvalue" value="" /></div>
		</tr>
		<tr>
		<th scope="row">비밀번호 : </th>
		<td><input onkeyup="passwordCheckFunciton();" type="password" id="userPassword1" name="userPassword1" size="20"></td>
		</tr>
		<tr>
		<th scope="row">비밀번호 확인 : </th>
		<td><input onkeyup="passwordCheckFunciton();" type="password" id="userPassword2" name="userPassword2" size="20"></td>
		</tr>
		<tr><th></th><td style="text-align: left;color: red; font-size: 0.8em" colspan="3" id="passwordCheckMessage"></td></tr>
		<tr>
		<th scope="row">이름 : </th><td><input type="text" id="userName" name="userName" size="20"></td>
		</tr>
		<tr><th></th><td style="text-align: left;color: red; font-size: 0.8em" colspan="3" id="nameCheckMessage"></td></tr>
		<tr>
		<th scope="row">메일 : </th><td><input type="text" id="usereMail" name="usereMail" value="${userid }" size="20"></td>
		</tr>
		<tr><th></th><td style="text-align: left;color: red; font-size: 0.8em" colspan="3" id="eMailCheckMessage"></td></tr>
		<td style="display:none;"><input type="text" id="authority" name="authority" size="20" value="${authority }"></td>
	</table>
	</form>
</div>
...
<tr>
<tr ><th></th><td style="text-align: left;color: red; font-size: 0.8em" colspan="3" id="fCheckBox"></td></tr>
</tr>
  <tr>
	<td colspan="2">
...
<tr>
<tr ><th></th><td style="text-align: left;color: red; font-size: 0.8em" colspan="3" id="sCheckBox"></td></tr>
</tr>
<tr>
...
<tr><td><input type="button" value="회원가입" onclick="joinFormCheck()"></td></tr>
</table>
</div>
</div>

...
<script>
	...
	function checkwrite(){
		...
		if($(':radio[name="payment"]:checked').length < 1){
			...
			var check_submit=confirm('등록을 진행하시겠습니까?');
			return check_submit;
		}
	}
</script>
...
<div class="row">
	...
	<div style="margin:0 auto; width:1000px;">
		...
		<form method="post" action="meetupwrite" enctype="multipart/form-data" onSubmit="return checkwrite()">
			<table class="table table-bordered table-hover"
				style="text-align: center; border: 1px solid #dddddd;">
				<tbody>
					<tr>
						<td>제목</td>
						<td colspan="4"><input class="form-control" type="text" id="title" name="title"></td>
					</tr>
					...
					<td rowspan="3">문의/연락처</td>
						<td>담당자명</td>
						<td colspan="2"><input class="form-control" type="text" id="mName" name="mName"></td>
					</tr>
					
					<tr>
						<td>전화번호</td>
						<td colspan="2"><input class="form-control" type="text" id="mTel" name="mTel"></td>
					</tr>
					
					<tr>
						<td>이메일</td>
						<td colspan="2"><input class="form-control" type="text" id="mEmail" name="mEmail"></td>
					</tr>
					<tr>
						<td>간단한 모임소개</td>
						<td colspan="4"><input class="form-control" type="text" id="tIntro" name="tIntro"></td>
					...
					<tr>
						...
						<td colspan="4"><textarea class="form-control" rows="10"
								...
								placeholder="글 내용을 입력하세요."></textarea> <script>
...
<!-- 								<span class="input-group-addon"><i class="glyphicon glyphicon-picture"></i></span>  -->
								<input type="file" name="tFile" class="file" placeholder="파일을 업로드하세요." required/> 
							</div></td>
					</tr>
					...
					<tr>
						<td>모집인원</td>
						<td colspan="3"><input class="form-control" type="text" id="tMemnum" name="tMemnum"></td>
					</tr>
					<tr>
						<td>참가비</td>
						<td colspan="3"><div class="btn-group" data-toggle="buttons">
								<input type="radio" onclick="charge();" name="payment"
									id="option1" value="charge">유료 <input type="radio" onclick="free();"
						...
						<td colspan="4">
							...
							<div class="btn-group" data-toggle="buttons">
								<input type="radio" onclick="offlineselect();" name="tSpaceType"
									id="option1" value="offline">오프라인 
								<input type="radio" onclick="zoom();" name="tSpaceType" 
									id="option2" value="online">온라인
					...
					<tr>
						<td style="text-align: left;" colspan="5"><a
							href="allclassview" class="btn btn-default pull-right"
